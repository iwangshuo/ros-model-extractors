...
class RosSystemModelParser(object):
    def __init__(self, model, isFile=True):
        ...
        print("ros system model parser init")
        ...
        # self._model = model
        # self._model = "/home/wshuo/catkin_ws/src/rosgraph_monitor/resources/test.rossystem"
        self._model = "/home/wshuo/catkin_ws/src/ros_graph_parser/result/tb3_empty_world.rossystem"
        self._isFile = isFile
        print("ros system model parser init end")
    ...
    def parse(self):
        print("ros system model parser .parse start 000")
        # self._result = ParseResults()
        # __new__() takes at least 2 arguments (1 given)
        self._result = None
        print("ros system model parser .parse start")
        try:
            if self._isFile:
        ...
        print("ros system model parser .parse end")
        return self._result
